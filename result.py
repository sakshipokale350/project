...
class resultClass:
    def __init__(self,root):
        ...
        btn_search=Button(self.root,text="Search",font=("goudy old style",15,"bold"),bg="blue",fg="white",cursor="hand2",command=self.search).place(x=500,y=100,width=120,height=20)
        ...
        #=====button=======
        btn_add=Button(self.root,text="SUBMIT",font=("goudy old style",15,"bold"),bg="red",activebackground="lightgreen",cursor="hand2",command=self.add).place(x=300,y=420,width=120,height=35)
        btn_clear=Button(self.root,text="CLEAR",font=("goudy old style",15,"bold"),bg="gray",activebackground="orange",cursor="hand2",command=self.clear).place(x=430,y=420,width=120,height=35)
